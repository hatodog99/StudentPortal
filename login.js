...
darkmodeBtn.addEventListener('click', function(){
    ...
    document.getElementById("resetDiv").style.background = "rgba(73, 73, 73, 0.45)";
    ...
    document.getElementById("loginDiv").style.background = "rgba(73, 73, 73, 0.45)";
    ...
    document.getElementsByClassName("inputDetail").style.background = "rgba(184, 184, 184, 0.3)";
